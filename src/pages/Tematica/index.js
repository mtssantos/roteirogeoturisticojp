                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="nav-solo" role="tabpanel" aria-labelledby="nav-solo-tab">
                                                <nav class="nav flex-column menu-floop">
                                                    <Link to="/local/12" class="nav-link local">Arenização das Barreiras</Link>
                                                </nav>
                                            </div>
                                            <div class="tab-pane fade" id="nav-relevo" role="tabpanel" aria-labelledby="nav-relevo-tab">
                                                <nav class="nav flex-column menu-floop">
                                                    ...
                                                    <Link to="/local/11" class="nav-link local">Grutas Das Marés</Link>
                                                </nav>
                                            </div>
                                            <div class="tab-pane fade" id="nav-rochas" role="tabpanel" aria-labelledby="nav-rochas-tab">
                                                <nav class="nav flex-column menu-floop">
                                                    ...
                                                    <Link to="/local/7" class="nav-link local">Afloramento da Formação Gramame</Link>
                    ...
                    <div class="card">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade" id="nav-obelisco" role="tabpanel" aria-labelledby="nav-obelisco-tab">
                                <nav class="nav flex-column menu-floop">
                                        <Link to="/local/3" class="nav-link local">Obelisco na Praça da Pedra</Link>
                            ...
                            <div class="tab-pane fade" id="nav-pedestral" role="tabpanel" aria-labelledby="nav-pedestral-tab">
                                <nav class="nav flex-column menu-floop">
                                    <Link to="/local/18" class="nav-link local">Jardim da Academia</Link>
                                    ...
                                    <Link to="/local/21" class="nav-link local">Estátua em Homenagem a Nossa Senhora das Lourdes</Link>
                            ...
                            <div class="tab-pane fade" id="nav-residencia" role="tabpanel" aria-labelledby="nav-residencia-tab">
                                <nav class="nav flex-column menu-floop">
                                    <Link to="/local/18" class="nav-link local">Academia de Letras da Paraíba</Link>
                                    <Link to="/local/16" class="nav-link local">Correios</Link>
                                    <Link to="/local/16" class="nav-link local">Casa do Erário</Link>
                                    <Link to="/local/25" class="nav-link local">Casa de Quartzo Rosa</Link>
                                </nav>
                            </div>
                            ...
                            <div class="tab-pane fade" id="nav-igreja" role="tabpanel" aria-labelledby="nav-igreja-tab">
                                <nav class="nav flex-column menu-floop">
                                    ...
                                    <Link to="/local/22" class="nav-link local">Mosteiro de São Benedito</Link>
                                    <Link to="/local/19" class="nav-link local">Centro Cultural de São Francisco</Link>
                                </nav>
                            </div>
                        </div>
                        </div>

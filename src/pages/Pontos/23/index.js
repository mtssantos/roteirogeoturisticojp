...
export function Milagres(){
    return(
        ...
        <h2>Fonte dos Milagres</h2>
            ...
            <p>Apresenta as mesmas características da Fonte de Santo Antônio. Com altidude em torno de 17 metros, localizada no contato do arenito Barreiras e do calcário Gramame, é uma ‘fonte de contato geológico’, assim como uma ‘fonte de falha’, por se localizar na vertente que representa um plano de falha.</p>
            <p>Foi selecionado como um importante elemento da geodiversidade local pelo seu alto valor científico como representante do afloramento do Aquífero Barreiras e por fazer parte da história do abastecimento da cidade. Sua denominação é um clássico exemplo do valor cultural da geodiversidade em seu viés mitológico.</p>
        </div>
        </>
    )
}
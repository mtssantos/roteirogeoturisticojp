...
export function Alvares(){
    return(
        <>
            <p>Segundo o Jornal a União (30.11.1923), em 29 de novembro de 1923, a pedido do Governador Solon de Lucena (1920-1924), amigos e familiares, a estátua em homenagem ao ex-governador Álvaro Lopes Machado (1892-1896) talhada em bronze maciço, proveniente da Europa, inaugurada em 03 de fevereiro do ano seguinte (foto 1a).</p>
            ...
            <p>Ambos os volumes do pedestal são compostos por um sienogranito, de proveniência desconhecida, com textura fanerítica fina a média, e matriz composta por quartzo, plagioclásio, biotita e opacos (provavelmente titanita) e por fenocristais de K-feldspato (foto 1b, c). O volume superior apresentam mais plagioclásio e quartzo e menos K-feldspato que o inferior.</p>
            <div class="text-center">
                    <figure class="figure">

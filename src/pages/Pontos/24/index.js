    ...
    return(
        ...
        <div class="container text-1">
            <h2>Falha de Sanhauá</h2>
                    ...
                    <p>Os excepcionais valores estético e científico, aliados ao altíssimo valor funcional justifica considerar a ‘Falha do Sanhauá’ como um representante do geopatrimônio da área. </p>
                    </div>
        </>
    )
}
...
export function Misericordia(){
    return(
		...
		<p className="text-article">Entretanto, Herckmans (1982) escreveu que</p>
		...
		<p className="text-article">Construída em calcário em blocos paralelepipédicos com cerca de 40cm de comprimento por 25cm de espessura, em algumas paredes assentados sem utilização de argamassa.</p>
		<p className="text-article">Esse calcário pertence à Formação Gramame, do Grupo Paraíba, com fácies visível a olho nu, semelhante à fácies i) aflorante na pedreira da Intercement. As características mineralógicas em lâmina delgada podem ser vistas na descrição do citado Local de Interesse. Na época da construção, era extraído de pedreiras localizadas no pátio do Conjunto Franciscano e na vertente dos tabuleiros voltada para o Rio Sanhauá.</p>
		<p className="text-article">Atualmente, as linhas austeras, as cicatrizes do calcário expostas nas paredes de alvenaria, as extremidades das entradas dos ambientes com sua cantaria e as reformas que obliteraram os traços, rebocados com argamassa expressam a mistura de sentimentos que se tem ao adentrar em uma das igrejas mais antigas da Capital. </p>
		<p className="text-article">Essa edificação foi tombada pelo IPHAN, em 25 de abril de 1938, inscrita no nº 103 do Livro de Tombo das Belas Artes.</p>
		<hr />

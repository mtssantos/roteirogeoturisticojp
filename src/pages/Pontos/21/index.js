        ...
        <div className="container text-1">
            ...
            <nav>
                    <div className="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <a className="nav-link lt" id="nav-matriz-tab" data-toggle="tab" href="#nav-matriz" role="tab" aria-controls="nav-matriz" aria-selected="false">Igreja Matriz</a>
                        <a className="nav-link lt" id="nav-lourdes-tab" data-toggle="tab" href="#nav-lourdes" role="tab" aria-controls="nav-lourdes" aria-selected="false">Estatua a Nossa Senhora de Lourdes</a>
                    </div>
                    </nav>

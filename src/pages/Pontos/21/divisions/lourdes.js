...
export function Lourdes(){
    return(
        <>
            <p className="text-article">Segundo o Jornal a União (12.02.1922), em 11 de Fevereiro de 1922 foi inaugurado a Estátua em homenagem a Nossa Senhora de Lourdes, no centro da Praça, medindo 8 metros de altura no total, sendo que a estátua, de bronze, mede 3 metros (foto 1). Foi tombado pelo IPHAEP em dezembro de 2015.</p>

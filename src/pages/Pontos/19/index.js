...
export function SaoFrancisco(){
    return(
        ...
        <div class="container text-1">
                ...
                <p className="text-article">Localiza-se na Praça São Francisco, início da rua Duque de Caxias. Faz parte do Conjunto a Igreja de Santo Antônio, o Convento de São Francisco e a ordem Terceira de São Francisco (figura 1), acrescido do horto com a fonte de Santo Antônio, essa um Local de Interesse que será discriminado à parte posteriormente. Por estar entre os mais belos representantes da arquitetura barroca nacional, uma belíssima expressão artística na arte da cantaria portuguesa, além da presença do patrimônio azulejar nas paredes do adro e fósseis em seu piso, justifica-se esse local como Interesse Geoturísico.</p>
                ...
                <p className="text-article">O amplo átrio conserva ainda o piso original em calcário, o forro com pintura simples, sendo a portada principal, que dá acesso à nave da Igreja, o elemento que mais se destaca por ser ricamente trabalhada em pedra. As paredes da nave são ornamentadas por azulejos datados da década de 1730, de autoria do artista português Teotónio dos Santos, e retrata a saga de José do Egito (ESTÁCIO FERNANDES, 2016, informação oral). O púlpito, com elementos figurativos de anjos decorando o teto, possui um guarda-corpo guarnecido por uma balastrada torneada.</p>
        </div>
        </>
    )
}
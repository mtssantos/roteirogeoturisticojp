    ...
    return(
        ...
        <nav>
                <div className="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a className="nav-link lt" id="nav-direito-tab" data-toggle="tab" href="#nav-direito" role="tab" aria-controls="nav-definicao" aria-selected="false">Faculdade de Direito</a>
                    <a className="nav-link lt" id="nav-redencao-tab" data-toggle="tab" href="#nav-redencao" role="tab" aria-controls="nav-definicao" aria-selected="false">Palácio da Redenção</a>
                </div>
                </nav>

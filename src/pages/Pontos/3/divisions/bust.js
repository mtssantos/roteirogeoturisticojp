...
export function Busto(){
	...
	<p className="text-article">Para a confluência das Avenidas Epitácio Pessoa e Maximiano Figueiredo, no setor leste da praça, foi transferido, nos anos 1960, um busto em homenagem ao presidente Epitácio Pessoa, que até então estava na Praça João Pessoa (foto 3).</p>
  ...
  <p className="text-article"	>Apresenta um bom estado de conservação, apesar do acúmulo de poeira e impregnações de resíduos sólidos (excrementos de aves e de insetos), pichações e colagem de propaganda.</p>

    ...
    return(
        ...
        <nav>
                <div className="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a className="nav-link lt" id="nav-obelisco-tab" data-toggle="tab" href="#nav-obelisco" role="tab" aria-controls="nav-historico" aria-selected="false">Obelisk</a>
                    <a className="nav-link lt" id="nav-busto-tab" data-toggle="tab" href="#nav-busto" role="tab" aria-controls="nav-definicao" aria-selected="false">Epitácio Pessoa Bust</a>
                </div>
                </nav>
